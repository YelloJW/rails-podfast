...
unemployed_episode = Episode.new(listens: 1999, img_url: unemployed_img_url, title: "How do you prepare for an interview?", summary: "A series for those in need of laughter when looking for a job in tech. We share our weird and wonderful anecodetes from those dark, dark days.", url: unemployed_url, length: rand(1..180), upvotes: 955)
