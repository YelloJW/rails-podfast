...
Episode.create(img_url: comedy_img_url_array[7], title: "#12 - What Really Happened At Zane's Birthday Party", summary: "Zane went missing at his own birthday and was later found with a lot of rumors to clear up! Who needs a shot of espresso when you have and episode this good?", length: rand(1..180), upvotes: rand(1..1000), url: comedy_url_array[6])
Episode.create(img_url: comedy_img_url_array[8], title: "Do Fish Drink Water?", summary: "For the first, and probably last time, Emma tries to answer a yes or no question - do fish drink water? After that, she gets into Thanksgiving dinners and how to prevent your family from arguing at the dinner table.", length: rand(1..180), upvotes: rand(1..1000), url: comedy_url_array[8])
Episode.create(img_url: comedy_img_url_array[9], title: "404 - Jan Pieterszoon Coen (live)", summary: "Comedians Dave Anthony and Gareth Reynolds examine Jan Pieterszoon Coen of the Dutch East India Company. Recorded live in Amsterdam.Tour DatesSourcesRedbubble Merch", length: rand(1..180), upvotes: rand(1..1000), url: comedy_url_array[9])
