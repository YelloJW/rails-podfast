...
unemployed_episode = Episode.new(listens: 1999, img_url: unemployed_img_url, title: "How do you prepare for an interview?", summary: "For those in need of a laugh while looking for their next tech job. We discuss some of the weirdest things we've seen at tech interviews, including what to do and definitely what not to do!", url: unemployed_url, length: rand(1..180), upvotes: 955)
